...
def isWinner(w, nums):
    ...
    # initialized to 1
    a = [1 for w in range(sorted(nums)[-1] + 1)]
...
def rm_multiples(ls, w):
    ...
    Args:
        ...
        w (int): The prime number to remove multiples of.
    ...
    # list ls. Starting from 2, it sets every multiple of w up to the
    # length of ls to 0. If the index i * w is out of range for the list ls,
